...
class MBConvBlock(nn.Module):
    ...
    def __init__(self, block_args, global_params, norm_cfg):
        ...
        if self._block_args.expand_ratio != 1:
            ...
            self._bn0 = build_norm_layer(
                norm_cfg, num_features=oup, postfix=0)[1]
        ...
        self._bn2 = build_norm_layer(
            norm_cfg, num_features=final_oup, postfix=2)[1]
...
class EfficientNet(nn.Module):
    ...
    def __init__(self,
        ...
        self._bn0 = build_norm_layer(
            norm_cfg, num_features=out_channels, postfix=0)[1]
        ...
        for block_args in self._blocks_args:
            ...
            self._blocks.append(
                MBConvBlock(block_args, self._global_params, norm_cfg))
