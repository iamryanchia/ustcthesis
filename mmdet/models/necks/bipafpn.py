...
class BiPaFPNLayer(nn.Module):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 activation=None):
        super(BiPaFPNLayer, self).__init__()
    ...
    def forward(self, inputs):
        ...
        for i in range(1, self.num_outs - 1):
            inputs_list = [outputs[i], inputs[i], outputs[i - 1]]
            if i % 2 == 0:
